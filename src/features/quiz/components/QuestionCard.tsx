...
// [DOCS] Komponen UI untuk menampilkan satu kartu pertanyaan dan opsi jawabannya.
...
export default function QuestionCard({ question }: Props) {
    ...
    // [DOCS] Cek apakah soal ini sudah punya jawaban di store
                ...
                <div className="space-y-3">
                    {question.options.map((option, idx) => {
                        ...
                        return (
                            <button
                                key={option}
                                // [DOCS] Update state jawaban di Zustand store saat opsi diklik
