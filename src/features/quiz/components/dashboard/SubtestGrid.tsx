...
// [DOCS] Komponen Grid untuk menampilkan daftar Subtest (Kuis) yang tersedia.
// Menangani status tombol Start/Lock berdasarkan ada tidaknya sesi aktif.
    ...
    return (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {subtests.map((item, index) => {
                // [DOCS] Cek apakah item ini yang sedang diklik (loading state spesifik per kartu)
                ...
                return (
                    ...
                    >
                        {/* [DOCS] Header berwarna dengan gradien dinamis */}
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <Button
                                ...
                                // [DOCS] Disable tombol jika sudah ada sesi lain yang aktif (Single Session Policy)
