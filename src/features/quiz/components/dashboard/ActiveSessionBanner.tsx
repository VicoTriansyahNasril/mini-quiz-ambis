...
// [DOCS] Komponen Banner yang muncul HANYA jika user memiliki sesi kuis aktif.
// Memberikan pilihan: Lanjutkan (Resume) atau Bersihkan (Reset).
...
export default function ActiveSessionBanner({ session, isExpired, isCleaning, onContinue, onClean }: Props) {
    ...
    // [DOCS] Tampilan Merah/Orange jika sesi sudah expired tapi belum disubmit (Stuck)
    if (isExpired) {
        return (
    ...
    // [DOCS] Tampilan Biru jika sesi masih aktif (Live)
    return (
