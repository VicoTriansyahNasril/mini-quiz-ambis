...
// [DOCS] Footer navigasi kuis (Prev, Next, Submit).
// Memiliki dua varian tampilan: Fixed (Mobile) dan Static (Desktop).
...
export default function QuizFooter({
    ...
    // [DOCS] Tampilan Desktop (Static di dalam flow layout)
    if (variant === 'static') {
        return (
    ...
    // [DOCS] Tampilan Mobile (Sticky Fixed di bawah layar)
    return (
