...
// [DOCS] Halaman Utama Dashboard.
// Menampilkan: Banner Sesi Aktif, Statistik Singkat, dan Daftar Kuis (SubtestGrid).
...
export default function DashboardPage() {
    ...
    // [DOCS] Loading screen penuh saat inisialisasi dashboard
    if (isLoading) {
        return (
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/20 to-indigo-50/20 p-4 md:p-6">
            ...
            <main className="max-w-6xl mx-auto space-y-8">
                {/* [DOCS] Banner muncul jika ada sesi kuis yang belum selesai */}
                <ActiveSessionBanner
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {/* [DOCS] Widget Statistik Sederhana */}
