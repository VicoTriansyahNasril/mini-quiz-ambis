...
// [DOCS] Halaman Pengerjaan Kuis (Core Feature).
// Halaman ini sangat kompleks karena menangani:
// 1. Sinkronisasi data sesi (loading, error, expiry).
// 2. Tampilan responsif (Desktop sidebar / Mobile drawer).
// 3. Navigasi soal & Pilihan jawaban.
// 4. Modal submit & Logika timer.
...
export default function QuizSessionPage() {
    ...
    // [DOCS] Tampilan Error 500 (Server Down)
    if (isError) {
        if (isServerError) {
            return (
    ...
    // [DOCS] Loading Screen dengan animasi Shimmer
    ...
    return (
        <div className="h-dvh bg-linear-to-br from-slate-50 via-blue-50/10 to-indigo-50/10 flex flex-col overflow-hidden">
            <div className="flex-none z-30">
                ...
                />
                {/* [DOCS] Progress bar linear di bawah header */}
            ...
            <main className="flex-1 overflow-y-auto w-full max-w-7xl mx-auto p-4 md:p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                <div className="md:col-span-8 lg:col-span-9 space-y-4 pb-20 md:pb-0">
                    ...
                    {/* Action Bar (Flag & Status Indicator) */}
